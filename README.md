...
| ------------- | ------------- | ------------- | ----- |
| [iFunza Parent App](https://play.google.com/store/apps/details?id=com.onesha.ifunza_cross&pcampaignid=web_share) | <div align='center' title='Commercial' >💰</div> | Parent Engagement app for the payment of school fees , Journals, Real time school calender, Announcements etc | Flutter, Dart (Flutter RiverPod, Dio, i18n, Firebase, Getx, Graphql, etc.) |
| [iFunza Driver App ios](https://appstoreconnect.apple.com/apps/1559935083/distribution/info) | <div align='center' title='Commercial' >💰</div> |Driver app for drivers to manage Trips  on school Buses. He can start trip and end while the school view real time view of bus location | Flutter, Dart (Flutter RiverPod, Dio, i18n, Firebase, Getx, Graphql, etc) |
...
| [iFunza Web](app.ifunza.com) | <div align='center' title='Commercial'>💰</div> | School Admin to manage invoices , manage expences and bulk actions|  TypeScript, Zustand,Next js, React, Redux, Ant d,Tailwind CSS Graphql, React Query, Codegen,Fastify , Graphql Yoga,Prisma, Postgres, Digital Ocean, Azure Pipelines,Azure App Services |
